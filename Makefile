...
all: compress uncompress ECcompress ECuncompress

compress: BitInputStream.o BitOutputStream.o HCNode.o HCTree.o

ECcompress: BitInputStream.o BitOutputStream.o HCNode.o HCTree.o

uncompress: BitInputStream.o BitOutputStream.o HCNode.o HCTree.o

ECuncompress: BitInputStream.o BitOutputStream.o HCNode.o HCTree.o
